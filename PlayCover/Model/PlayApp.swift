...
extension PlayApp {
    ...
    func applyNanaoriBuiltinMousePatch() {
        ...
        let success = Macho.patch(
            url: executable,
            bytesToFind: Data([0xE2, 0x03, 0x00, 0x91, 0x81, 0x01, 0x80, 0x52,
                               0x00, 0x01, 0x3F, 0xD6, 0xC0, 0x0D, 0x00, 0x37]),
    ...
    func applyNikkeTTSMiniGamePatch() {
        ...
        let success = Macho.patch(
            url: unityFramework,
            bytesToFind: Data([0xE1, 0x03, 0x00, 0xAA, 0xC0, 0x00, 0x00, 0xB5,
                               0xE0, 0x03, 0x1A, 0xAA, 0xE1, 0x03, 0x1B, 0xAA]),
